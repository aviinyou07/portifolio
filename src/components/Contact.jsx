...
const socials = [
  ...
  },
  {
    ...
    alt: 'LinkedIn',
    href: 'https://www.linkedin.com/in/aviinyou07'
  },
  {
    ...
    alt: 'Instagram',
    href: 'https://www.instagram.com/a_anomalous/'
  },
]
...
const Contact = () => {
  return (
    <section className="section" id='Contact'>
        <div className="container lg:flex lg:grid-cols-2 lg:items-stretch">
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                <h2 className="headline-2 lg:max-w-[12ch]">
                    Contact me
                </h2>
                <p className="text-zinc-400 mt-3 mb-8  lg:max-w-[50ch] lg:max-w-[30ch]">
                    Whether you have a question, a project idea, or just want to connect — feel free to reach out. I'm always open to discussing new opportunities, collaborations, or simply talking tech.
You can contact me via email or connect through any of my social profiles below. Let's build something great together!


                </p>
                <div className="flex justify-center items-center gap-2 mt-auto">
                    {socials.map(({href, icon,alt}, key) => (
                      <a href={href}
                      key={key}
                      target='_blank'
                      alt={alt}
            ...
            >
              ...
              <div className="mb-4">
                ...
                <button type='submit'
                className='btn btn-primary [&]:max-w-full w-full justify-center mt-1'>
                  Send 
                </button>
              </div>
            </form>
